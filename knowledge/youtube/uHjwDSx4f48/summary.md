---
videoId: "uHjwDSx4f48"
sourceUrl: "https://www.youtube.com/watch?v=uHjwDSx4f48"
...
entity_tags: ["gemini", "openclaw"]
topic_tags: ["openclaw", "workflow-automation", "seo-content", "prompt-design", "business-idea", "business-opportunity", "seo-distribution", "agent-flow", "agent-automation", "product-opportunity", "api", "api-integration"]
topic_cluster_key: "gemini"
related_video_ids: ["_s7tHRZUmdM", "98bGqof0dUI", "1LU_AHdrfNU", "ZgnQb40aiTU", "NtpPIFj7HD0"]
...
5. And we also have 100 prompts and use cases, for example, for Google Sheets, Google Docs, etc.
